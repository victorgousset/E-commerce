...
// Style //
import './CommandesProducteurs.css';
import { AiFillDelete, AiTwotoneSetting, AiTwotoneEye } from 'react-icons/ai';
import { Button, Container, Row, Col } from 'react-bootstrap';

class CommandesProducteurs extends React.Component {
  constructor(props) {
    super(props);
      ...
      return (
        <div className="admin-categorie">
          <center>
            <Container>
              <Col>
                <h3 className="commandes-admin">Commandes en Cours </h3><br />
                        ...
                        return (
                          <tr key={i}>
                            ...
                            <td className="admin-table_td">
                              <p className="action-icons" value={item.id} onClick={this.onDelete}>Annuler</p>
                            </td>
                          </tr>
                        )
                      }
                ...
                <Link to={{ pathname: "/admin/commandes/producteur/historique" }}><button className="admin-button">Historique</button></Link>
              </Col>
            </Container>
          </center>
        </div>
...
export default CommandesProducteurs;
